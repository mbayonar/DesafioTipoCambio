package com.tcs.marcosbr.configuracion;
...
@EntityScan(basePackages = {"com.tcs.marcosbr.entidad"})
@EnableAutoConfiguration
public class BackTipoCambioConfiguracion {
    ...
    public LocalSessionFactoryBean sessionFactory() throws Exception {
        ...
        bean.setPackagesToScan("com.tcs.marcosbr.entidad");
